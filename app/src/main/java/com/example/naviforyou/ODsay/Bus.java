...
public class Bus implements Serializable {
    ...
    public String what(JSONObject jsonObject) {
        try {
            ...
            BusInfo_1[4] = subPath.getJSONObject(J).getString("endName");//하차정류장역명
            ...
            BusInfo_3=new String[stations.length()];
            for (int k = 0; k < stations.length(); k++) {
                BusInfo_3[k] = stations.getJSONObject(k).getString("stationName");
            }

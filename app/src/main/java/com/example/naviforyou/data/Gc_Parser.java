...
public class Gc_Parser {
   ...
   //통신을 위한 메서드
    public Gc connectNaver(String coords, String placeTitle) //위경도, 건물이름
    {
        Log.d("tag","tag : " + coords + " , " + placeTitle);
        try{
            //심벌 좌표
            Log.d("coords",coords);
            this.coords = URLEncoder.encode(coords,"UTF-8");
